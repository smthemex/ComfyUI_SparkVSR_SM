...
class Args(BaseModel):
    ...
    ref_guidance_scale: float = 1.0 # The guidance scale for reference frames during validation.
    ...
    ref_dropout_ratio: float = 0.0 # The ratio of reference dropout in the training set
    pisa_sr_ref_dir: Path | str | None = None # The offline computed PiSA-SR reference frame directory
    pisa_sr_ratio: float = 0.0 # The ratio of pisa-sr frames vs GT frames used as references
    ...
    def parse_args(cls):
        ...
        parser.add_argument("--tracker_name", type=str, default="VSR")
        ...
        parser.add_argument("--ref_guidance_scale", type=float, default=1.0) # The guidance scale for reference frames during validation.
        ...
        parser.add_argument("--ref_dropout_ratio", type=float, default=0.0) # The ratio of reference dropout in the training set
        parser.add_argument("--pisa_sr_ref_dir", type=str, default=None)
        parser.add_argument("--pisa_sr_ratio", type=float, default=0.0)
